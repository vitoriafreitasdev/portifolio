        ...
        <div>
            ...
            <div className="div-projects">
                    ...
                    <ul className="ul-projects">
                        <li>Reac Services</li>
                        <p>Um CRUD para fazer solicitação de serviços para veículo, você cadastra seus dados e de acordo com seu orçamento pode solicitar serviços para o seu veículo. Utiliza react router dom, axios react tostify, no backend NodeJs, mongoose, express, bcrypt, jsonwebtoken e mongoDB Atlas.</p>
                        <p>Repoitório <a className="link" href="#">Aqui</a></p>
