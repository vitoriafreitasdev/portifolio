    ...
    <div className='main-container'>
      <div className='introduction-div'>
        ...
        <p className="aboutme-p">
          Me chamo Vitória Freitas, 22 anos. Iniciei os estudos em março de 2024, comecei por apenas curiosidade, agora quero que seja minha profissão, por tanto estou a procura de um estágio
        </p>    
